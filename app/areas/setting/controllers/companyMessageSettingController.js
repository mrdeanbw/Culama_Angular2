...
(function (culamaApp) {
    ...
    (function (areas) {
        ...
        (function (setting) {
            ...
            (function (controllers) {
                var CompanyMessageSettingController = (function () {
                    ...
                    CompanyMessageSettingController.prototype.saveCompany = function (RecipientID, actionname) {
                        var _this = this;
                        this.$rootScope.$emit("toggleLoader", true);
                        this.companyService.saveCompanyDetail(this.scope.Customer).then(function (result) {
                            _this.$rootScope.$emit("toggleLoader", false);
                            if (result.data != "") {
                                _this.scope.Customer = result.data;
                                var cmobj = _this;
                    ...
                    CompanyMessageSettingController.prototype.saveCompanyUser = function (user, isupdateallusers) {
                        var _this = this;
                        this.$rootScope.$emit("toggleLoader", true);
                        this.loginService.saveUserDetail(user).then(function (result) {
                            _this.$rootScope.$emit("toggleLoader", false);
                            if (result.data != "") {
                    ...
                    CompanyMessageSettingController.prototype.getSelectedUserInfo = function (selecteduserid, isAllowMessage) {
                        var _this = this;
                        this.$rootScope.$emit("toggleLoader", true);
                        this.loginService.getUserDetailsbyId(selecteduserid).then(function (result) {
                    ...
                    CompanyMessageSettingController.prototype.getRecipients = function (recipientUserIDs) {
                        ...
                        for (var i = 0; i < splitedUsers.length; i++) {
                            this.loginService.getUserDetailsbyId(splitedUsers[i]).then(function (result) {
                ...
                controllers.customFilterForAllowMessage = customFilterForAllowMessage;
            ...
            })(controllers = setting.controllers || (setting.controllers = {}));
        })(setting = areas.setting || (areas.setting = {}));
